...
public class DustTypeBallBullet : BallBullet {
    ...
    {
        //충돌한 게임오브젝트의 태그값 비교
        if (other.transform.tag == "Tank" || other.transform.tag == "DestroyObject" || other.transform.tag == "Soldier" || other.transform.tag == "EnemyTank")
        {
            ...
            if (col.transform.tag == "Tank" || col.transform.tag == "DestroyObject" || col.transform.tag == "Soldier" || col.transform.tag == "EnemyTank")
            {
                if (!hitTankPlayer.Contains(col.gameObject))
                {
                    if (col.transform.tag == "Tank" || col.transform.tag == "Soldier" || col.transform.tag == "EnemyTank")
                    {
                        ...
                        BulletDamageManager.Instance.GetDustEffect(col.gameObject);
